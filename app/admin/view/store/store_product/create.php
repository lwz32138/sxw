                                ...
                                <div class="layui-col-xs12 layui-col-sm12 layui-col-md12">
                                    <div class="grid-demo grid-demo-bg1">
                                        <div class="layui-form-item" v-if="id">
                                            <button class="layui-btn layui-btn-primary layui-btn-sm" type="button" @click="handleSubmit()">保存</button>
                                        ...
                                        <div class="layui-form-item" v-else>
                                            ...
                                            <button class="layui-btn layui-btn-normal layui-btn-sm" type="button" v-if="layTabId == 3" @click="handleSubmit()">提交</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
